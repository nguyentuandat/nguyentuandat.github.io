...
- **Claude (Anthropic):** Preferred for analyzing large code contexts and generating safe, concise explanations.
- **Grok & Gemini:** utilized for up-to-date tech research and comparative analysis.

## Creative & Design AI
- **Midjourney & PromeAI:** Generating assets, placeholders, and creative inspiration for UI designs.
- **v0.dev:** Rapid prototyping of React components using generative UI techniques.
