...
## CI/CD
- **GitHub Actions:** Writing workflows for automated testing, building, and deploying React and Node.js applications.
- **Jenkins:** Configuring pipelines for legacy projects and custom build requirements.

## Containerization
- **Docker:** Dockerizing Node.js and PHP applications for consistent development and production environments. Writing Docker Compose files for multi-service orchestration.
